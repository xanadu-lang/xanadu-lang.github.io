...
var xtop40;
var xtop101;
// ./JS_StreamDemo.dats: 21(line=2, offs=1) -- 73(line=4, offs=29)
// { // include
...
// ./JS_StreamDemo.dats: 94(line=6, offs=1) -- 122(line=6, offs=29)
// L1DCLnone1(H0Cnone1(...))

// ./JS_StreamDemo.dats: 144(line=9, offs=1) -- 480(line=36, offs=18)
{
// ./JS_StreamDemo.dats: 186(line=13, offs=1) -- 259(line=19, offs=7)
function
fromto_189_(a1x1)
{
let xtmp1;
...
;
// ./JS_StreamDemo.dats: 260(line=20, offs=1) -- 456(line=35, offs=7)
function
helper_263_(a1x1)
{
let xtmp7;
...
// ./JS_StreamDemo.dats: 528(line=40, offs=1) -- 697(line=54, offs=6)
// { // local
// ./JS_StreamDemo.dats: 535(line=42, offs=1) -- 562(line=42, offs=28)
{
{
...
// in-of-local
// ./JS_StreamDemo.dats: 570(line=46, offs=1) -- 607(line=47, offs=34)
function
dir_set_next_573_()
{
let xtmp37;
...
// ./JS_StreamDemo.dats: 608(line=48, offs=1) -- 645(line=49, offs=34)
function
dir_set_prev_611_()
{
let xtmp38;
...
// ./JS_StreamDemo.dats: 649(line=51, offs=1) -- 690(line=52, offs=34)
// L1DCLnone0()
// } // end-of-local


// ./JS_StreamDemo.dats: 736(line=58, offs=1) -- 785(line=60, offs=28)
{
{
// ././StreamDemo.dats: 294(line=22, offs=1) -- 1637(line=137, offs=8)
function
StreamDemo_moves_219_(a1x1)
{
let xtmp98;
let xtmp99;
let xtmp100;
;
// ././StreamDemo.dats: 441(line=38, offs=1) -- 905(line=79, offs=6)
function
aux0_444_(a2x1, a2x2)
{
let xtmp44;
...
let xtmp63;
let xtmp64;
// ././StreamDemo.dats: 511(line=46, offs=1) -- 539(line=47, offs=19)
{
{
// ./JS_StreamDemo.dats: 649(line=51, offs=1) -- 690(line=52, offs=34)
function
...
;
// ././StreamDemo.dats: 951(line=81, offs=1) -- 1590(line=135, offs=6)
function
...
let xtmp95;
let xtmp96;
// ././StreamDemo.dats: 1038(line=91, offs=1) -- 1066(line=92, offs=19)
{
{
// ./JS_StreamDemo.dats: 649(line=51, offs=1) -- 690(line=52, offs=34)
function
...
;
// ././StreamDemo.dats: 345(line=28, offs=1) -- 384(line=31, offs=16)
{
{
xtmp98 = [0];
}
...
;
xtop40 = StreamDemo_moves_219_(xtop31);
}
;
;
...
// ./JS_StreamDemo.dats: 786(line=61, offs=1) -- 839(line=63, offs=28)
{
{
// ./../../../../xanadu/prelude/DATS/array.dats: 243(line=22, offs=1) -- 304(line=26, offs=20)
function
...
;
;
} // val(H0Pvar(thePrimes_moves_ref(48)))


// ./JS_StreamDemo.dats: 872(line=68, offs=1) -- 914(line=69, offs=39)


// ./JS_StreamDemo.dats: 923(line=71, offs=1) -- 965(line=72, offs=39)


// ./JS_StreamDemo.dats: 974(line=74, offs=1) -- 1021(line=75, offs=44)


// ./JS_StreamDemo.dats: 1030(line=77, offs=1) -- 1084(line=78, offs=51)


// ./JS_StreamDemo.dats: 1088(line=80, offs=1) -- 1315(line=93, offs=8)
function
JS_StreamDemo_next()
{
let xtmp105;
...
let xtmp112;
let xtmp113;
// ./JS_StreamDemo.dats: 1123(line=83, offs=1) -- 1146(line=84, offs=15)
{
{
...
;
// ./JS_StreamDemo.dats: 1147(line=85, offs=1) -- 1180(line=86, offs=25)
{
{
// ./../../../../xanadu/prelude/DATS/CATS/JS/basics.dats: 10737(line=732, offs=1) -- 10786(line=734, offs=33)
// { // val-binding
...
;
// ./JS_StreamDemo.dats: 1181(line=87, offs=1) -- 1211(line=87, offs=31)
{
xtmp107 = XATS2JS_lazy_eval(xtmp106);
if(1!==xtmp107[0]) XATS2JS_patckerr0();
;
xtmp108 = xtmp107[1];
xtmp109 = xtmp107[2];
} // val(H0Pdapp(H0Pcon(strmcon_cons(0)); -1; H0Pvar(x0(54)), H0Pvar(xs(55))))
;
// ./JS_StreamDemo.dats: 1212(line=88, offs=1) -- 1249(line=89, offs=29)
{
{
// ./../../../../xanadu/prelude/DATS/CATS/JS/basics.dats: 10891(line=743, offs=1) -- 10940(line=745, offs=33)
// { // val-binding
...
xtmp113 = xtmp108[1];
{
xtmp111 = JS_StreamDemo_show_some(xtmp113);
}
;
break;
default: XATS2JS_matcherr0();
...
;
return xtmp111;
} // function // JS_StreamDemo_next(28)


// ./JS_StreamDemo.dats: 1358(line=95, offs=1) -- 1627(line=109, offs=8)
function
JS_StreamDemo_prev()
{
let xtmp114;
...
let xtmp121;
let xtmp122;
// ./JS_StreamDemo.dats: 1393(line=98, offs=1) -- 1416(line=99, offs=15)
{
{
...
;
// ./JS_StreamDemo.dats: 1417(line=100, offs=1) -- 1450(line=101, offs=25)
{
{
// ./../../../../xanadu/prelude/DATS/CATS/JS/basics.dats: 10737(line=732, offs=1) -- 10786(line=734, offs=33)
// { // val-binding
...
;
// ./JS_StreamDemo.dats: 1451(line=102, offs=1) -- 1481(line=102, offs=31)
{
xtmp116 = XATS2JS_lazy_eval(xtmp115);
if(1!==xtmp116[0]) XATS2JS_patckerr0();
;
xtmp117 = xtmp116[1];
xtmp118 = xtmp116[2];
} // val(H0Pdapp(H0Pcon(strmcon_cons(0)); -1; H0Pvar(x0(58)), H0Pvar(xs(59))))
;
// ./JS_StreamDemo.dats: 1482(line=103, offs=1) -- 1519(line=104, offs=29)
{
{
// ./../../../../xanadu/prelude/DATS/CATS/JS/basics.dats: 10891(line=743, offs=1) -- 10940(line=745, offs=33)
// { // val-binding
...
case 1:
{
xtmp120 = JS_StreamDemo_show_none();
}
;
break;
case 2:
xtmp122 = xtmp117[1];
{
xtmp120 = JS_StreamDemo_show_some(xtmp122);
}
;
break;
default: XATS2JS_matcherr0();
...
;
return xtmp120;
} // function // JS_StreamDemo_prev(29)
