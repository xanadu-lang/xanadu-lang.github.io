...
// ./JS_StreamDemo.dats: 528(line=40, offs=1) -- 569(line=41, offs=38)
{
{
...
;
xtop33 = a0ref_make_2230_(xtop31);
}
;
;
} // val(H0Pvar(thePrimes_ref(17)))


// ./JS_StreamDemo.dats: 592(line=45, offs=1) -- 1002(line=66, offs=6)
// { // local
// ./JS_StreamDemo.dats: 598(line=46, offs=1) -- 648(line=47, offs=43)
// L1DCLnone0()
// ./JS_StreamDemo.dats: 649(line=48, offs=1) -- 705(line=49, offs=49)
// L1DCLnone0()
// in-of-local
// ./JS_StreamDemo.dats: 720(line=53, offs=1) -- 762(line=54, offs=39)

// ./JS_StreamDemo.dats: 771(line=56, offs=1) -- 824(line=57, offs=50)

// ./JS_StreamDemo.dats: 825(line=58, offs=1) -- 956(line=64, offs=8)
function
JS_StreamDemo_next()
{
let xtmp37;
...
let xtmp50;
let xtmp51;
// ./JS_StreamDemo.dats: 860(line=61, offs=1) -- 892(line=61, offs=33)
{
{
// ././StreamDemo.dats: 290(line=20, offs=1) -- 527(line=36, offs=8)
function
StreamDemo$next_234_()
{
let xtmp38;
let xtmp40;
let xtmp41;
...
let xtmp45;
let xtmp48;
// ././StreamDemo.dats: 333(line=24, offs=1) -- 361(line=24, offs=29)
{
{
// ./JS_StreamDemo.dats: 598(line=46, offs=1) -- 648(line=47, offs=43)
function
...
;
xtmp39 = a0ref_get_2379_(xtop33);
}
;
return xtmp39;
} // function // StreamDemo$get(16)
;
xtmp38 = StreamDemo$get_112_();
}
;
;
} // val(H0Pvar(xs(23)))
;
xtmp41 = XATS2JS_lazy_eval(xtmp38);
{
xtmp42 = 0;
do {
do {
...
xtmp43 = xtmp41[1];
xtmp44 = xtmp41[2];
// ././StreamDemo.dats: 451(line=33, offs=3) -- 484(line=34, offs=24)
{
{
// ./JS_StreamDemo.dats: 649(line=48, offs=1) -- 705(line=49, offs=49)
function
...
;
return xtmp47;
} // function // StreamDemo$set(18)
;
xtmp45 = StreamDemo$set_159_(xtmp44);
}
;
...
;
return xtmp40;
} // function // StreamDemo$next(22)
;
xtmp37 = StreamDemo$next_234_();
}
;
;
} // val(H0Pvar(opt(22)))
...
xtmp51 = xtmp37[1];
{
xtmp49 = JS_StreamDemo_show_int(xtmp51);
}
;
break;
default: XATS2JS_matcherr0();
...
;
return xtmp49;
} // function // JS_StreamDemo_next(20)
