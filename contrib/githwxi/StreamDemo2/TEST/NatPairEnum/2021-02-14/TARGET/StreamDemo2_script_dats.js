...
var xtop0;
var xtop93;
// ./NatPairEnum.dats: 21(line=2, offs=1) -- 73(line=4, offs=29)
// { // include
...
// ./NatPairEnum.dats: 102(line=7, offs=1) -- 138(line=8, offs=24)
// L1DCLnone1(H0Cnone1(...))

// ./NatPairEnum.dats: 147(line=10, offs=1) -- 185(line=11, offs=25)
// L1DCLnone1(H0Cnone1(...))

// ./NatPairEnum.dats: 206(line=13, offs=1) -- 250(line=15, offs=33)
// L1DCLnone1(H0Cnone1(...))

// ./NatPairEnum.dats: 251(line=16, offs=1) -- 296(line=17, offs=37)
// L1DCLnone1(H0Cnone1(...))

// ./NatPairEnum.dats: 297(line=18, offs=1) -- 342(line=19, offs=37)
// L1DCLnone1(H0Cnone1(...))

// ./NatPairEnum.dats: 363(line=21, offs=1) -- 395(line=23, offs=13)
// L1DCLnone1(H0Cnone1(...))

// ./NatPairEnum.dats: 416(line=25, offs=1) -- 473(line=27, offs=26)
// L1DCLnone0()

// ./NatPairEnum.dats: 494(line=29, offs=1) -- 565(line=31, offs=34)
// L1DCLnone0()

// ./NatPairEnum.dats: 566(line=32, offs=1) -- 695(line=34, offs=89)
// L1DCLnone0()

// ./NatPairEnum.dats: 716(line=36, offs=1) -- 979(line=57, offs=13)
// L1DCLnone0()

// ./NatPairEnum.dats: 1036(line=59, offs=1) -- 1182(line=68, offs=8)
// L1DCLnone0()

// ./NatPairEnum.dats: 1271(line=75, offs=1) -- 1314(line=75, offs=44)
// { // include
...
{
let xtmp107;
// ./NatPairEnum.dats: 772(line=41, offs=1) -- 977(line=56, offs=8)
function
helper1_775_(a2x1)
{
let xtmp95;
;
{
xtmp95 = helper2_833_(a2x1, 0);
}
;
return xtmp95;
} // function // helper1(4)
function
helper2_833_(a2x1, a2x2)
{
let xtmp98;
let xtmp106;
;
...
;
xtmp101 = gint_sub_sint_sint_3524_(a2x1, a2x2);
}
;
xtmp100 = [-1, a2x2, xtmp101];;
}
;
{
...
;
xtmp103 = gint_lt_sint_sint_2125_(a2x2, a2x1);
}
;
if
(xtmp103)
...
;
xtmp104 = gint_add_sint_sint_3439_(a2x2, 1);
}
;
xtmp102 = helper2_833_(a2x1, xtmp104);
}
;
} // if-then
else
...
gint_add_sint_sint_3439_ = XATS2JS_gint_add_sint_sint
;
xtmp105 = gint_add_sint_sint_3439_(a2x1, 1);
}
;
xtmp102 = helper1_775_(xtmp105);
}
;
} // if-else
;
xtmp99 = [1, xtmp100, xtmp102];
}
;
return xtmp99;
} // lam-function
;
xtmp98 = XATS2JS_new_lazy(xtmp106);
return xtmp98;
} // function // helper2(5)
;
{
xtmp107 = helper1_775_(0);
}
;
return xtmp107;
...
a0ref_get_3025_ = XATS2JS_a0ref_get
;
xtmp113 = a0ref_get_3025_(a4x1[2]);
}
;
;
} // val(H0Pvar(xs(57)))
...
{
xtmp114 = XATS2JS_lazy_eval(xtmp113);
if(0!==xtmp114[0]) XATS2JS_patckerr0();
;
xtmp115 = xtmp114[1];
xtmp116 = xtmp114[2];
} // val(H0Pdapp(H0Pcon(strxcon_cons(4)); -1; H0Pvar(x0(58)), H0Pvar(xs(59))))
;
...
;
xtmp117 = a0ref_set_3064_(a4x1[2], xtmp116);
}
;
//L1PCKxpat(H0Pnil(); L1VALtmp(tmp(117)));
//L1CMDmatch(H0Pnil(); L1VALtmp(tmp(117)));
} // val(H0Pnil())
;
return xtmp115;
} // function // StreamDemo_get_elt(39)
;
xtmp111 = StreamDemo_get_elt_202_(a3x1);
}
;
;
} // val(H0Pvar(opt(55)))
...
do {
do {
if(0!==xtmp111[0]) break;
xtmp119 = 1;
} while(false);
if(xtmp119 > 0 ) break;
do {
if(1!==xtmp111[0]) break;
xtmp119 = 2;
} while(false);
if(xtmp119 > 0 ) break;
} while(false);
...
a0ref_set_3064_ = XATS2JS_a0ref_set
;
xtmp123 = a0ref_set_3064_(a3x1[1], a3x2);
}
;
return xtmp123;
} // function // StreamDemo_set_dir(42)
;
{
// /home/hwxi/Research/ATS-Xanadu/prelude/DATS/CATS/JS/basics.dats: 3589(line=255, offs=1) -- 3646(line=256, offs=50)
// { // val-binding
...
gint_sub_sint_sint_3524_ = XATS2JS_gint_sub_sint_sint
;
xtmp124 = gint_sub_sint_sint_3524_(0, 1);
}
;
xtmp120 = StreamDemo_set_dir_343_(a2x1, xtmp124);
}
;
//L1PCKxpat(H0Pnil(); L1VALtmp(tmp(120)));
//L1CMDmatch(H0Pnil(); L1VALtmp(tmp(120)));
} // val(H0Pnil())
;
{
xtmp125 = loop_3023_(a2x1);
}
;
return xtmp125;
} // function // StreamDemo_reset(37)
;
xtmp108 = StreamDemo_reset_433_(xtop0);
}
;
return xtmp108;
} // function // the_StreamDemo2_reset(11)
...
a0ref_set_3064_ = XATS2JS_a0ref_set
;
xtmp131 = a0ref_set_3064_(a3x1[1], a3x2);
}
;
return xtmp131;
} // function // StreamDemo_set_dir(42)
...
gint_add_sint_sint_3439_ = XATS2JS_gint_add_sint_sint
;
xtmp132 = gint_add_sint_sint_3439_(0, 1);
}
;
xtmp128 = StreamDemo_set_dir_343_(a2x1, xtmp132);
}
;
//L1PCKxpat(H0Pnil(); L1VALtmp(tmp(128)));
//L1CMDmatch(H0Pnil(); L1VALtmp(tmp(128)));
} // val(H0Pnil())
;
{
// ././../../../StreamDemo/DATS/StreamDemo.dats: 2424(line=205, offs=1) -- 2628(line=220, offs=15)
...
a0ref_get_3025_ = XATS2JS_a0ref_get
;
xtmp135 = a0ref_get_3025_(a3x1[2]);
}
;
;
} // val(H0Pvar(xs(57)))
...
a0ref_set_3064_ = XATS2JS_a0ref_set
;
xtmp139 = a0ref_set_3064_(a3x1[2], xtmp138);
}
;
...
;
xtmp133 = StreamDemo_get_elt_202_(a2x1);
}
;
return xtmp133;
} // function // StreamDemo_next1(43)
;
xtmp126 = StreamDemo_next1_492_(xtop0);
}
;
return xtmp126;
} // function // the_StreamDemo2_next1(12)
...
a0ref_get_3025_ = XATS2JS_a0ref_get
;
xtmp149 = a0ref_get_3025_(a3x1[2]);
}
;
;
} // val(H0Pvar(xs(57)))
...
// ././../../../StreamDemo/DATS/StreamDemo.dats: 2547(line=215, offs=1) -- 2578(line=216, offs=27)
{
xtmp150 = XATS2JS_lazy_eval(xtmp149);
if(0!==xtmp150[0]) XATS2JS_patckerr0();
;
xtmp151 = xtmp150[1];
xtmp152 = xtmp150[2];
} // val(H0Pdapp(H0Pcon(strxcon_cons(4)); -1; H0Pvar(x0(58)), H0Pvar(xs(59))))
...
a0ref_set_3064_ = XATS2JS_a0ref_set
;
xtmp153 = a0ref_set_3064_(a3x1[2], xtmp152);
}
;
//L1PCKxpat(H0Pnil(); L1VALtmp(tmp(153)));
//L1CMDmatch(H0Pnil(); L1VALtmp(tmp(153)));
} // val(H0Pnil())
;
return xtmp151;
} // function // StreamDemo_get_elt(39)
;
xtmp147 = StreamDemo_get_elt_202_(a2x1);
}
;
return xtmp147;
} // function // StreamDemo_prev1(44)
;
xtmp140 = StreamDemo_prev1_554_(xtop0);
}
;
return xtmp140;
} // function // the_StreamDemo2_prev1(13)
...
;
return xtmp154;
} // function // the_StreamDemo2_title(14)
...
{
return "Enumerating Pairs of Naturals";
} // function // StreamDemo2_stream_name(1)
;
xtmp155 = StreamDemo2_stream_name_234_();
}
;
return xtmp155;
} // function // the_StreamDemo2_stream_name(15)
...
{
return "The stream of pairs of naturals: (0, 0), (0, 1), (1, 0), (0, 2), (1, 1), (2, 0), ...";
} // function // StreamDemo2_input_descript(2)
;
xtmp156 = StreamDemo2_input_descript_389_();
}
;
return xtmp156;
} // function // the_StreamDemo2_input_descript(16)
...
;
return false;
} // function // StreamDemo2_pauseq(45)
;
xtmp158 = StreamDemo2_pauseq_637_(a1x1);
}
;
return xtmp158;
} // function // the_StreamDemo2_pauseq(17)
...
gl_print1_2233_ = g_print_2168_
;
xtmp176 = gl_print1_2233_(a3x4);
}
;
//L1PCKxpat(H0Pnil(); L1VALtmp(tmp(176)));
//L1CMDmatch(H0Pnil(); L1VALtmp(tmp(176)));
} // val(H0Pnil())
;
...
gl_print1_2233_ = g_print_2168_
;
xtmp178 = gl_print1_2233_(a3x6);
}
;
//L1PCKxpat(H0Pnil(); L1VALtmp(tmp(178)));
//L1CMDmatch(H0Pnil(); L1VALtmp(tmp(178)));
} // val(H0Pnil())
;
...
;
xtmp163 = print_7_1000_("(", "i=", xtmp165[1], ", ", "j=", xtmp165[2], ")");
}
;
break;
default: XATS2JS_matcherr0();
...
;
xtmp161 = StreamDemo2_xprint_776_(a1x1);
}
;
return xtmp161;
} // function // the_StreamDemo2_xprint(18)
