...
var xtop0;
var xtop93;
// ./RMJPairEnum.dats: 21(line=2, offs=1) -- 73(line=4, offs=29)
// { // include
...
// ./RMJPairEnum.dats: 102(line=7, offs=1) -- 138(line=8, offs=24)
// L1DCLnone1(H0Cnone1(...))

// ./RMJPairEnum.dats: 147(line=10, offs=1) -- 185(line=11, offs=25)
// L1DCLnone1(H0Cnone1(...))

// ./RMJPairEnum.dats: 206(line=13, offs=1) -- 250(line=15, offs=33)
// L1DCLnone1(H0Cnone1(...))

// ./RMJPairEnum.dats: 251(line=16, offs=1) -- 296(line=17, offs=37)
// L1DCLnone1(H0Cnone1(...))

// ./RMJPairEnum.dats: 297(line=18, offs=1) -- 342(line=19, offs=37)
// L1DCLnone1(H0Cnone1(...))

// ./RMJPairEnum.dats: 363(line=21, offs=1) -- 395(line=23, offs=13)
// L1DCLnone1(H0Cnone1(...))
...
{
{
// /home/hwxi/Research/ATS-Xanadu/prelude/DATS/CATS/JS/prelude.dats: 7043(line=428, offs=1) -- 7094(line=430, offs=35)
// { // val-binding
// } // val-binding
const // implval/fun
a0ptr_make_2915_ = XATS2JS_a0ptr_make
;
xtmp5 = a0ptr_make_2915_(a2x1);
}
;
...
;
return xtmp4;
} // function // a0ref_make(23)
;
xtmp2 = a0ref_make_2876_(0);
}
;
;
} // val(H0Pvar(mydir(31)))
...
let xtmp17;
{
// /home/hwxi/Research/ATS-Xanadu/prelude/DATS/CATS/JS/prelude.dats: 7339(line=449, offs=1) -- 7388(line=451, offs=33)
// { // val-binding
// } // val-binding
const // implval/fun
a0ref_get_3025_ = XATS2JS_a0ref_get
;
xtmp17 = a0ref_get_3025_(xtmp2);
}
;
return xtmp17;
} // function // StreamDemo$dir(27)
;
...
;
return xtmp92;
} // function // StreamDemo_moves(29)
;
xtmp11 = StreamDemo_moves_673_(a1x1);
}
;
xtmp7 = a0ref_make_2876_(xtmp11);
}
;
xtmp6 = [-1, xtmp2, xtmp7];;
}
...
;
{
// /home/hwxi/Research/ATS-Xanadu/prelude/DATS/stream.dats: 7485(line=613, offs=1) -- 7965(line=654, offs=8)
function
stream_merge_3897_(a4x1, a4x2)
{
let xtmp138;
;
;
// /home/hwxi/Research/ATS-Xanadu/prelude/DATS/stream.dats: 7558(line=621, offs=1) -- 7963(line=653, offs=6)
function
merge_7561_(a5x1, a5x2)
{
let xtmp103;
let xtmp137;
;
...
let xtmp135;
let xtmp136;
xtmp105 = XATS2JS_lazy_eval(a5x1);
{
xtmp106 = 0;
do {
do {
...
(xtmp106) {
case 1:
xtmp104 = XATS2JS_lazy_eval(a5x2);
break;
case 2:
xtmp107 = xtmp105[1];
xtmp108 = xtmp105[2];
xtmp109 = XATS2JS_lazy_eval(a5x2);
{
xtmp110 = 0;
do {
do {
if(0!==xtmp109[0]) break;
xtmp110 = 1;
} while(false);
if(xtmp110 > 0 ) break;
do {
if(1!==xtmp109[0]) break;
//L1PCKany();
//L1PCKany();
xtmp110 = 2;
} while(false);
...
(xtmp110) {
case 1:
xtmp104 = XATS2JS_lazy_eval(a5x1);
break;
case 2:
xtmp111 = xtmp109[1];
xtmp112 = xtmp109[2];
...
gint_mul_sint_sint_3609_ = XATS2JS_gint_mul_sint_sint
;
xtmp122 = gint_mul_sint_sint_3609_(xtmp116, xtmp116);
}
;
xtmp121 = gint_mul_sint_sint_3609_(xtmp122, xtmp116);
}
;
{
// /home/hwxi/Research/ATS-Xanadu/prelude/DATS/CATS/JS/basics.dats: 3753(line=266, offs=1) -- 3810(line=267, offs=50)
...
gint_mul_sint_sint_3609_ = XATS2JS_gint_mul_sint_sint
;
xtmp124 = gint_mul_sint_sint_3609_(xtmp117, xtmp117);
}
;
xtmp123 = gint_mul_sint_sint_3609_(xtmp124, xtmp117);
}
;
xtmp120 = gint_add_sint_sint_3439_(xtmp121, xtmp123);
}
;
;
} // val(H0Pvar(sum1(8)))
...
gint_mul_sint_sint_3609_ = XATS2JS_gint_mul_sint_sint
;
xtmp127 = gint_mul_sint_sint_3609_(xtmp118, xtmp118);
}
;
xtmp126 = gint_mul_sint_sint_3609_(xtmp127, xtmp118);
}
;
{
// /home/hwxi/Research/ATS-Xanadu/prelude/DATS/CATS/JS/basics.dats: 3753(line=266, offs=1) -- 3810(line=267, offs=50)
...
gint_mul_sint_sint_3609_ = XATS2JS_gint_mul_sint_sint
;
xtmp129 = gint_mul_sint_sint_3609_(xtmp119, xtmp119);
}
;
xtmp128 = gint_mul_sint_sint_3609_(xtmp129, xtmp119);
}
;
xtmp125 = gint_add_sint_sint_3439_(xtmp126, xtmp128);
}
;
;
} // val(H0Pvar(sum2(9)))
...
;
xtmp130 = gint_cmp_sint_sint_3209_(xtmp120, xtmp125);
}
;
;
} // val(H0Pvar(res0(10)))
...
;
xtmp132 = gint_neq_sint_sint_2555_(xtmp130, 0);
}
;
if
(xtmp132)
...
gint_cmp_sint_sint_3209_ = XATS2JS_gint_cmp_sint_sint
;
xtmp131 = gint_cmp_sint_sint_3209_(xtmp116, xtmp118);
}
;
} // if-else
;
...
;
xtmp113 = g_cmp_1644_(xtmp107, xtmp111);
}
;
;
} // val(H0Pvar(sgn(72)))
...
;
xtmp134 = gint_lte_sint_sint_2380_(xtmp113, 0);
}
;
if
(xtmp134)
...
{
{
xtmp135 = merge_7561_(xtmp108, a5x2);
}
;
xtmp133 = [1, xtmp107, xtmp135];
}
;
} // if-then
else
...
{
{
xtmp136 = merge_7561_(a5x1, xtmp112);
}
;
xtmp133 = [1, xtmp111, xtmp136];
}
;
} // if-else
;
...
;
xtmp103 = XATS2JS_new_lazy(xtmp137);
return xtmp103;
} // function // merge(37)
;
{
xtmp138 = merge_7561_(a4x1, a4x2);
}
;
return xtmp138;
} // function // stream_merge(10)
;
{
{
// /home/hwxi/Research/ATS-Xanadu/prelude/DATS/CATS/JS/basics.dats: 3428(line=245, offs=1) -- 3485(line=246, offs=50)
...
;
xtmp96 = [1, xtmp97, xtmp98];
}
;
return xtmp96;
} // lam-function
;
xtmp95 = XATS2JS_new_lazy(xtmp143);
return xtmp95;
} // function // helper1(4)
function
...
;
xtmp146 = XATS2JS_new_lazy(xtmp151);
return xtmp146;
} // function // helper2(11)
;
{
...
a0ref_get_3025_ = XATS2JS_a0ref_get
;
xtmp158 = a0ref_get_3025_(a4x1[2]);
}
;
;
} // val(H0Pvar(xs(78)))
...
{
xtmp159 = XATS2JS_lazy_eval(xtmp158);
if(0!==xtmp159[0]) XATS2JS_patckerr0();
;
xtmp160 = xtmp159[1];
xtmp161 = xtmp159[2];
} // val(H0Pdapp(H0Pcon(strxcon_cons(4)); -1; H0Pvar(x0(79)), H0Pvar(xs(80))))
;
// ././../../../StreamDemo/DATS/StreamDemo.dats: 2579(line=217, offs=1) -- 2615(line=218, offs=28)
{
{
// /home/hwxi/Research/ATS-Xanadu/prelude/DATS/CATS/JS/prelude.dats: 7493(line=460, offs=1) -- 7542(line=462, offs=33)
// { // val-binding
// } // val-binding
const // implval/fun
a0ref_set_3064_ = XATS2JS_a0ref_set
;
xtmp162 = a0ref_set_3064_(a4x1[2], xtmp161);
}
;
...
;
return xtmp160;
} // function // StreamDemo_get_elt(46)
;
xtmp156 = StreamDemo_get_elt_202_(a3x1);
}
;
;
} // val(H0Pvar(opt(76)))
...
do {
do {
if(0!==xtmp156[0]) break;
xtmp164 = 1;
} while(false);
if(xtmp164 > 0 ) break;
do {
if(1!==xtmp156[0]) break;
xtmp164 = 2;
} while(false);
if(xtmp164 > 0 ) break;
} while(false);
...
a0ref_set_3064_ = XATS2JS_a0ref_set
;
xtmp168 = a0ref_set_3064_(a3x1[1], a3x2);
}
;
return xtmp168;
} // function // StreamDemo_set_dir(49)
;
{
...
;
xtmp169 = gint_sub_sint_sint_3524_(0, 1);
}
;
xtmp165 = StreamDemo_set_dir_343_(a2x1, xtmp169);
}
;
//L1PCKxpat(H0Pnil(); L1VALtmp(tmp(165)));
//L1CMDmatch(H0Pnil(); L1VALtmp(tmp(165)));
} // val(H0Pnil())
;
{
xtmp170 = loop_3023_(a2x1);
}
;
return xtmp170;
} // function // StreamDemo_reset(44)
;
xtmp153 = StreamDemo_reset_433_(xtop0);
}
;
return xtmp153;
} // function // the_StreamDemo2_reset(14)
...
a0ref_set_3064_ = XATS2JS_a0ref_set
;
xtmp176 = a0ref_set_3064_(a3x1[1], a3x2);
}
;
return xtmp176;
} // function // StreamDemo_set_dir(49)
...
gint_add_sint_sint_3439_ = XATS2JS_gint_add_sint_sint
;
xtmp177 = gint_add_sint_sint_3439_(0, 1);
}
;
xtmp173 = StreamDemo_set_dir_343_(a2x1, xtmp177);
}
;
//L1PCKxpat(H0Pnil(); L1VALtmp(tmp(173)));
//L1CMDmatch(H0Pnil(); L1VALtmp(tmp(173)));
} // val(H0Pnil())
;
{
// ././../../../StreamDemo/DATS/StreamDemo.dats: 2424(line=205, offs=1) -- 2628(line=220, offs=15)
...
a0ref_get_3025_ = XATS2JS_a0ref_get
;
xtmp180 = a0ref_get_3025_(a3x1[2]);
}
;
;
} // val(H0Pvar(xs(78)))
...
// ././../../../StreamDemo/DATS/StreamDemo.dats: 2547(line=215, offs=1) -- 2578(line=216, offs=27)
{
xtmp181 = XATS2JS_lazy_eval(xtmp180);
if(0!==xtmp181[0]) XATS2JS_patckerr0();
;
xtmp182 = xtmp181[1];
xtmp183 = xtmp181[2];
} // val(H0Pdapp(H0Pcon(strxcon_cons(4)); -1; H0Pvar(x0(79)), H0Pvar(xs(80))))
...
a0ref_set_3064_ = XATS2JS_a0ref_set
;
xtmp184 = a0ref_set_3064_(a3x1[2], xtmp183);
}
;
...
;
xtmp178 = StreamDemo_get_elt_202_(a2x1);
}
;
return xtmp178;
} // function // StreamDemo_next1(52)
;
xtmp171 = StreamDemo_next1_492_(xtop0);
}
;
return xtmp171;
} // function // the_StreamDemo2_next1(15)
...
a0ref_set_3064_ = XATS2JS_a0ref_set
;
xtmp190 = a0ref_set_3064_(a3x1[1], a3x2);
}
;
return xtmp190;
} // function // StreamDemo_set_dir(49)
...
gint_sub_sint_sint_3524_ = XATS2JS_gint_sub_sint_sint
;
xtmp191 = gint_sub_sint_sint_3524_(0, 1);
}
;
xtmp187 = StreamDemo_set_dir_343_(a2x1, xtmp191);
}
;
//L1PCKxpat(H0Pnil(); L1VALtmp(tmp(187)));
//L1CMDmatch(H0Pnil(); L1VALtmp(tmp(187)));
} // val(H0Pnil())
;
{
// ././../../../StreamDemo/DATS/StreamDemo.dats: 2424(line=205, offs=1) -- 2628(line=220, offs=15)
...
a0ref_get_3025_ = XATS2JS_a0ref_get
;
xtmp194 = a0ref_get_3025_(a3x1[2]);
}
;
;
} // val(H0Pvar(xs(78)))
...
// ././../../../StreamDemo/DATS/StreamDemo.dats: 2547(line=215, offs=1) -- 2578(line=216, offs=27)
{
xtmp195 = XATS2JS_lazy_eval(xtmp194);
if(0!==xtmp195[0]) XATS2JS_patckerr0();
;
xtmp196 = xtmp195[1];
xtmp197 = xtmp195[2];
} // val(H0Pdapp(H0Pcon(strxcon_cons(4)); -1; H0Pvar(x0(79)), H0Pvar(xs(80))))
...
a0ref_set_3064_ = XATS2JS_a0ref_set
;
xtmp198 = a0ref_set_3064_(a3x1[2], xtmp197);
}
;
...
;
xtmp192 = StreamDemo_get_elt_202_(a2x1);
}
;
return xtmp192;
} // function // StreamDemo_prev1(53)
;
xtmp185 = StreamDemo_prev1_554_(xtop0);
}
;
return xtmp185;
} // function // the_StreamDemo2_prev1(16)
...
;
return xtmp199;
} // function // the_StreamDemo2_title(17)
...
;
return xtmp200;
} // function // the_StreamDemo2_stream_name(18)
...
;
return xtmp201;
} // function // the_StreamDemo2_input_descript(19)
...
;
{
// ././../../../StreamDemo2/StreamDemo2.dats: 687(line=43, offs=1) -- 736(line=45, offs=32)
function
StreamDemo2_pauseq_637_(a2x1)
{
;
return false;
} // function // StreamDemo2_pauseq(54)
;
xtmp203 = StreamDemo2_pauseq_637_(a1x1);
}
;
return xtmp203;
} // function // the_StreamDemo2_pauseq(20)
...
xtmp211 = xtmp210[1];
xtmp212 = xtmp210[2];
} // val(H0Ptuple(0; -1; H0Pvar(i(19)), H0Pvar(j(20))))
;
{
// /home/hwxi/Research/ATS-Xanadu/prelude/DATS/synougat.dats: 4434(line=372, offs=1) -- 4736(line=393, offs=16)
function
print_7_1000_(a3x1, a3x2, a3x3, a3x4, a3x5, a3x6, a3x7)
{
let xtmp221;
let xtmp222;
let xtmp223;
...
;
;
// /home/hwxi/Research/ATS-Xanadu/prelude/DATS/synougat.dats: 4534(line=386, offs=3) -- 4560(line=386, offs=29)
{
{
...
;
// /home/hwxi/Research/ATS-Xanadu/prelude/DATS/synougat.dats: 4563(line=387, offs=3) -- 4589(line=387, offs=29)
{
{
// /home/hwxi/Research/ATS-Xanadu/prelude/DATS/gbas.dats: 889(line=95, offs=1) -- 929(line=97, offs=26)
// { // val-binding
...
;
// /home/hwxi/Research/ATS-Xanadu/prelude/DATS/synougat.dats: 4592(line=388, offs=3) -- 4618(line=388, offs=29)
{
{
// /home/hwxi/Research/ATS-Xanadu/prelude/DATS/gbas.dats: 889(line=95, offs=1) -- 929(line=97, offs=26)
// { // val-binding
...
;
// /home/hwxi/Research/ATS-Xanadu/prelude/DATS/synougat.dats: 4621(line=389, offs=3) -- 4647(line=389, offs=29)
{
{
// /home/hwxi/Research/ATS-Xanadu/prelude/DATS/gbas.dats: 889(line=95, offs=1) -- 929(line=97, offs=26)
// { // val-binding
...
gl_print1_2233_ = g_print_2168_
;
xtmp224 = gl_print1_2233_(a3x4);
}
;
//L1PCKxpat(H0Pnil(); L1VALtmp(tmp(224)));
//L1CMDmatch(H0Pnil(); L1VALtmp(tmp(224)));
} // val(H0Pnil())
;
// /home/hwxi/Research/ATS-Xanadu/prelude/DATS/synougat.dats: 4650(line=390, offs=3) -- 4676(line=390, offs=29)
{
{
// /home/hwxi/Research/ATS-Xanadu/prelude/DATS/gbas.dats: 889(line=95, offs=1) -- 929(line=97, offs=26)
// { // val-binding
...
gl_print1_2233_ = g_print_2168_
;
xtmp225 = gl_print1_2233_(a3x5);
}
;
//L1PCKxpat(H0Pnil(); L1VALtmp(tmp(225)));
//L1CMDmatch(H0Pnil(); L1VALtmp(tmp(225)));
} // val(H0Pnil())
;
// /home/hwxi/Research/ATS-Xanadu/prelude/DATS/synougat.dats: 4679(line=391, offs=3) -- 4705(line=391, offs=29)
{
{
// /home/hwxi/Research/ATS-Xanadu/prelude/DATS/gbas.dats: 889(line=95, offs=1) -- 929(line=97, offs=26)
// { // val-binding
...
gl_print1_2233_ = g_print_2168_
;
xtmp226 = gl_print1_2233_(a3x6);
}
;
//L1PCKxpat(H0Pnil(); L1VALtmp(tmp(226)));
//L1CMDmatch(H0Pnil(); L1VALtmp(tmp(226)));
} // val(H0Pnil())
;
// /home/hwxi/Research/ATS-Xanadu/prelude/DATS/synougat.dats: 4708(line=392, offs=3) -- 4734(line=392, offs=29)
{
{
// /home/hwxi/Research/ATS-Xanadu/prelude/DATS/gbas.dats: 889(line=95, offs=1) -- 929(line=97, offs=26)
// { // val-binding
...
gl_print1_2233_ = g_print_2168_
;
xtmp227 = gl_print1_2233_(a3x7);
}
;
//L1PCKxpat(H0Pnil(); L1VALtmp(tmp(227)));
//L1CMDmatch(H0Pnil(); L1VALtmp(tmp(227)));
} // val(H0Pnil())
;
{
xtmp228 = [-1];;
...
gint_mul_sint_sint_3609_ = XATS2JS_gint_mul_sint_sint
;
xtmp231 = gint_mul_sint_sint_3609_(xtmp211, xtmp211);
}
;
xtmp230 = gint_mul_sint_sint_3609_(xtmp231, xtmp211);
}
;
{
// /home/hwxi/Research/ATS-Xanadu/prelude/DATS/CATS/JS/basics.dats: 3753(line=266, offs=1) -- 3810(line=267, offs=50)
...
gint_mul_sint_sint_3609_ = XATS2JS_gint_mul_sint_sint
;
xtmp233 = gint_mul_sint_sint_3609_(xtmp212, xtmp212);
}
;
xtmp232 = gint_mul_sint_sint_3609_(xtmp233, xtmp212);
}
;
xtmp229 = gint_add_sint_sint_3439_(xtmp230, xtmp232);
}
;
xtmp213 = print_7_1000_("(i=", xtmp211, ", j=", xtmp212, ", i^3+j^3=", xtmp229, ")");
}
;
xtmp208 = xtmp213;
break;
...
;
return xtmp208;
} // function // StreamDemo2_xprint(12)
;
xtmp206 = StreamDemo2_xprint_776_(a1x1);
}
;
return xtmp206;
} // function // the_StreamDemo2_xprint(21)
