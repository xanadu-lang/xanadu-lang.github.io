...
var xtop0;
var xtop93;
// ./PrimeNums.dats: 21(line=2, offs=1) -- 73(line=4, offs=29)
// { // include
...
// ./PrimeNums.dats: 102(line=7, offs=1) -- 138(line=8, offs=24)
// L1DCLnone1(H0Cnone1(...))

// ./PrimeNums.dats: 147(line=10, offs=1) -- 185(line=11, offs=25)
// L1DCLnone1(H0Cnone1(...))

// ./PrimeNums.dats: 206(line=13, offs=1) -- 250(line=15, offs=33)
// L1DCLnone1(H0Cnone1(...))

// ./PrimeNums.dats: 251(line=16, offs=1) -- 296(line=17, offs=37)
// L1DCLnone1(H0Cnone1(...))

// ./PrimeNums.dats: 297(line=18, offs=1) -- 342(line=19, offs=37)
// L1DCLnone1(H0Cnone1(...))

// ./PrimeNums.dats: 363(line=21, offs=1) -- 395(line=23, offs=13)
// L1DCLnone1(H0Cnone1(...))

// ./PrimeNums.dats: 416(line=25, offs=1) -- 473(line=27, offs=26)
// L1DCLnone0()

// ./PrimeNums.dats: 494(line=29, offs=1) -- 561(line=31, offs=30)
// L1DCLnone0()

// ./PrimeNums.dats: 562(line=32, offs=1) -- 659(line=34, offs=57)
// L1DCLnone0()

// ./PrimeNums.dats: 680(line=36, offs=1) -- 1076(line=72, offs=16)
// L1DCLnone0()

// ./PrimeNums.dats: 1133(line=74, offs=1) -- 1266(line=82, offs=8)
// L1DCLnone0()

// ./PrimeNums.dats: 1355(line=89, offs=1) -- 1398(line=89, offs=44)
// { // include
...
let xtmp128;
let xtmp129;
// ./PrimeNums.dats: 746(line=42, offs=1) -- 821(line=48, offs=7)
function
fromto_749_(a2x1)
{
let xtmp95;
...
;
xtmp97 = fromto_749_(xtmp98);
}
;
xtmp96 = [1, a2x1, xtmp97];
}
;
return xtmp96;
} // lam-function
;
xtmp95 = XATS2JS_new_lazy(xtmp99);
return xtmp95;
} // function // fromto(4)
;
// ./PrimeNums.dats: 822(line=49, offs=1) -- 1052(line=71, offs=7)
function
helper_825_(a2x1, a2x2)
{
let xtmp102;
let xtmp127;
;
...
let xtmp109;
let xtmp110;
// ./PrimeNums.dats: 894(line=59, offs=1) -- 925(line=60, offs=27)
{
xtmp103 = XATS2JS_lazy_eval(a2x2);
if(1!==xtmp103[0]) XATS2JS_patckerr0();
;
xtmp104 = xtmp103[1];
xtmp105 = xtmp103[2];
} // val(H0Pdapp(H0Pcon(strmcon_cons(0)); -1; H0Pvar(x0(6)), H0Pvar(xs(7))))
;
// ./PrimeNums.dats: 999(line=67, offs=1) -- 1044(line=68, offs=38)
// L1DCLnone0();
{
{
xtmp107 = [-1, a2x1, xtmp104];;
}
;
{
{
...
gint_add_sint_sint_3439_ = XATS2JS_gint_add_sint_sint
;
xtmp109 = gint_add_sint_sint_3439_(a2x1, 1);
}
;
{
// /home/hwxi/Research/ATS-Xanadu/prelude/DATS/stream.dats: 4376(line=375, offs=1) -- 4707(line=403, offs=8)
function
stream_filter_3275_(a4x1)
{
let xtmp126;
;
// /home/hwxi/Research/ATS-Xanadu/prelude/DATS/stream.dats: 4445(line=383, offs=1) -- 4705(line=402, offs=8)
function
auxmain_4448_(a5x1)
{
let a5y1;
...
let xtmp114;
{
xtmp114 = auxloop_4493_(XATS2JS_lazy_eval(a5x1));
}
;
return xtmp114;
} // lam-function
;
xtmp113 = XATS2JS_new_lazy(xtmp115);
break;//return
} while( true );
return xtmp113;
} // function // auxmain(36)
...
;
{
// /home/hwxi/Research/ATS-Xanadu/prelude/DATS/CATS/JS/basics.dats: 4078(line=286, offs=1) -- 4135(line=287, offs=50)
// { // val-binding
// } // val-binding
const // implval/fun
gint_mod_sint_sint_3788_ = XATS2JS_gint_mod_sint_sint
;
xtmp124 = gint_mod_sint_sint_3788_(a6x1, xtmp104);
}
;
xtmp123 = gint_gt_sint_sint_2209_(xtmp124, 0);
}
;
return xtmp123;
} // function // filter$test(7)
;
xtmp121 = filter$test_2509_(xtmp119);
}
;
if
(xtmp121)
...
{
{
xtmp125 = auxmain_4448_(xtmp120);
}
;
xtmp117 = [1, xtmp119, xtmp125];
}
;
} // if-then
else
...
{
// tail-recursion:
// L1CMDapp(tmp(117); L1VALfcst(auxloop(37)); L1VALeval2(L1VALtmp(tmp(120))))
a5y1 = XATS2JS_lazy_eval(xtmp120); a5x1 = a5y1; continue;
}
;
} // if-else
;
...
;
{
xtmp126 = auxmain_4448_(a4x1);
}
;
return xtmp126;
} // function // stream_filter(10)
;
xtmp110 = stream_filter_3275_(xtmp105);
}
;
xtmp108 = helper_825_(xtmp109, xtmp110);
}
;
xtmp106 = [1, xtmp107, xtmp108];
}
;
return xtmp106;
} // lam-function
;
xtmp102 = XATS2JS_new_lazy(xtmp127);
return xtmp102;
} // function // helper(6)
;
{
{
xtmp129 = fromto_749_(2);
}
;
xtmp128 = helper_825_(0, xtmp129);
}
;
return xtmp128;
...
a0ref_get_3025_ = XATS2JS_a0ref_get
;
xtmp135 = a0ref_get_3025_(a4x1[2]);
}
;
;
} // val(H0Pvar(xs(67)))
...
{
xtmp136 = XATS2JS_lazy_eval(xtmp135);
if(0!==xtmp136[0]) XATS2JS_patckerr0();
;
xtmp137 = xtmp136[1];
xtmp138 = xtmp136[2];
} // val(H0Pdapp(H0Pcon(strxcon_cons(4)); -1; H0Pvar(x0(68)), H0Pvar(xs(69))))
;
...
;
xtmp139 = a0ref_set_3064_(a4x1[2], xtmp138);
}
;
//L1PCKxpat(H0Pnil(); L1VALtmp(tmp(139)));
//L1CMDmatch(H0Pnil(); L1VALtmp(tmp(139)));
} // val(H0Pnil())
;
return xtmp137;
} // function // StreamDemo_get_elt(41)
;
xtmp133 = StreamDemo_get_elt_202_(a3x1);
}
;
;
} // val(H0Pvar(opt(65)))
...
do {
do {
if(0!==xtmp133[0]) break;
xtmp141 = 1;
} while(false);
if(xtmp141 > 0 ) break;
do {
if(1!==xtmp133[0]) break;
xtmp141 = 2;
} while(false);
if(xtmp141 > 0 ) break;
} while(false);
...
a0ref_set_3064_ = XATS2JS_a0ref_set
;
xtmp145 = a0ref_set_3064_(a3x1[1], a3x2);
}
;
return xtmp145;
} // function // StreamDemo_set_dir(44)
;
{
...
;
xtmp146 = gint_sub_sint_sint_3524_(0, 1);
}
;
xtmp142 = StreamDemo_set_dir_343_(a2x1, xtmp146);
}
;
//L1PCKxpat(H0Pnil(); L1VALtmp(tmp(142)));
//L1CMDmatch(H0Pnil(); L1VALtmp(tmp(142)));
} // val(H0Pnil())
;
{
xtmp147 = loop_3023_(a2x1);
}
;
return xtmp147;
} // function // StreamDemo_reset(39)
;
xtmp130 = StreamDemo_reset_433_(xtop0);
}
;
return xtmp130;
} // function // the_StreamDemo2_reset(13)
...
a0ref_set_3064_ = XATS2JS_a0ref_set
;
xtmp153 = a0ref_set_3064_(a3x1[1], a3x2);
}
;
return xtmp153;
} // function // StreamDemo_set_dir(44)
...
gint_add_sint_sint_3439_ = XATS2JS_gint_add_sint_sint
;
xtmp154 = gint_add_sint_sint_3439_(0, 1);
}
;
xtmp150 = StreamDemo_set_dir_343_(a2x1, xtmp154);
}
;
...
a0ref_get_3025_ = XATS2JS_a0ref_get
;
xtmp157 = a0ref_get_3025_(a3x1[2]);
}
;
;
} // val(H0Pvar(xs(67)))
...
// ././../../../StreamDemo/DATS/StreamDemo.dats: 2547(line=215, offs=1) -- 2578(line=216, offs=27)
{
xtmp158 = XATS2JS_lazy_eval(xtmp157);
if(0!==xtmp158[0]) XATS2JS_patckerr0();
;
xtmp159 = xtmp158[1];
xtmp160 = xtmp158[2];
} // val(H0Pdapp(H0Pcon(strxcon_cons(4)); -1; H0Pvar(x0(68)), H0Pvar(xs(69))))
...
a0ref_set_3064_ = XATS2JS_a0ref_set
;
xtmp161 = a0ref_set_3064_(a3x1[2], xtmp160);
}
;
...
;
xtmp155 = StreamDemo_get_elt_202_(a2x1);
}
;
return xtmp155;
} // function // StreamDemo_next1(47)
;
xtmp148 = StreamDemo_next1_492_(xtop0);
}
;
return xtmp148;
} // function // the_StreamDemo2_next1(14)
...
a0ref_set_3064_ = XATS2JS_a0ref_set
;
xtmp167 = a0ref_set_3064_(a3x1[1], a3x2);
}
;
return xtmp167;
} // function // StreamDemo_set_dir(44)
...
gint_sub_sint_sint_3524_ = XATS2JS_gint_sub_sint_sint
;
xtmp168 = gint_sub_sint_sint_3524_(0, 1);
}
;
xtmp164 = StreamDemo_set_dir_343_(a2x1, xtmp168);
}
;
//L1PCKxpat(H0Pnil(); L1VALtmp(tmp(164)));
//L1CMDmatch(H0Pnil(); L1VALtmp(tmp(164)));
} // val(H0Pnil())
;
{
// ././../../../StreamDemo/DATS/StreamDemo.dats: 2424(line=205, offs=1) -- 2628(line=220, offs=15)
...
a0ref_get_3025_ = XATS2JS_a0ref_get
;
xtmp171 = a0ref_get_3025_(a3x1[2]);
}
;
;
} // val(H0Pvar(xs(67)))
...
// ././../../../StreamDemo/DATS/StreamDemo.dats: 2547(line=215, offs=1) -- 2578(line=216, offs=27)
{
xtmp172 = XATS2JS_lazy_eval(xtmp171);
if(0!==xtmp172[0]) XATS2JS_patckerr0();
;
xtmp173 = xtmp172[1];
xtmp174 = xtmp172[2];
} // val(H0Pdapp(H0Pcon(strxcon_cons(4)); -1; H0Pvar(x0(68)), H0Pvar(xs(69))))
...
a0ref_set_3064_ = XATS2JS_a0ref_set
;
xtmp175 = a0ref_set_3064_(a3x1[2], xtmp174);
}
;
...
;
xtmp169 = StreamDemo_get_elt_202_(a2x1);
}
;
return xtmp169;
} // function // StreamDemo_prev1(48)
;
xtmp162 = StreamDemo_prev1_554_(xtop0);
}
;
return xtmp162;
} // function // the_StreamDemo2_prev1(15)
...
;
xtmp176 = StreamDemo2_title_97_();
}
;
return xtmp176;
} // function // the_StreamDemo2_title(16)
...
{
return "Enumerating Prime Numbers";
} // function // StreamDemo2_stream_name(1)
;
xtmp177 = StreamDemo2_stream_name_234_();
}
;
return xtmp177;
} // function // the_StreamDemo2_stream_name(17)
...
{
return "The stream of prime numbers: 2, 3, 5, 7, 11, 13, ...";
} // function // StreamDemo2_input_descript(2)
;
xtmp178 = StreamDemo2_input_descript_389_();
}
;
return xtmp178;
} // function // the_StreamDemo2_input_descript(18)
...
;
xtmp180 = StreamDemo2_pauseq_637_(a1x1);
}
;
return xtmp180;
} // function // the_StreamDemo2_pauseq(19)
...
xtmp187 = a2x1[1];
{
// /home/hwxi/Research/ATS-Xanadu/prelude/DATS/synougat.dats: 3672(line=306, offs=1) -- 3860(line=321, offs=12)
function
print_4_626_(a3x1, a3x2, a3x3, a3x4)
{
let xtmp192;
let xtmp193;
let xtmp194;
...
;
;
// /home/hwxi/Research/ATS-Xanadu/prelude/DATS/synougat.dats: 3745(line=317, offs=3) -- 3771(line=317, offs=29)
{
{
...
;
xtmp192 = gl_print1_2233_(a3x1);
}
;
//L1PCKxpat(H0Pnil(); L1VALtmp(tmp(192)));
//L1CMDmatch(H0Pnil(); L1VALtmp(tmp(192)));
} // val(H0Pnil())
;
// /home/hwxi/Research/ATS-Xanadu/prelude/DATS/synougat.dats: 3774(line=318, offs=3) -- 3800(line=318, offs=29)
{
{
// /home/hwxi/Research/ATS-Xanadu/prelude/DATS/gbas.dats: 889(line=95, offs=1) -- 929(line=97, offs=26)
// { // val-binding
...
gl_print1_2233_ = g_print_2168_
;
xtmp193 = gl_print1_2233_(a3x2);
}
;
//L1PCKxpat(H0Pnil(); L1VALtmp(tmp(193)));
//L1CMDmatch(H0Pnil(); L1VALtmp(tmp(193)));
} // val(H0Pnil())
;
// /home/hwxi/Research/ATS-Xanadu/prelude/DATS/synougat.dats: 3803(line=319, offs=3) -- 3829(line=319, offs=29)
{
{
// /home/hwxi/Research/ATS-Xanadu/prelude/DATS/gbas.dats: 889(line=95, offs=1) -- 929(line=97, offs=26)
// { // val-binding
...
;
// /home/hwxi/Research/ATS-Xanadu/prelude/DATS/synougat.dats: 3832(line=320, offs=3) -- 3858(line=320, offs=29)
{
{
// /home/hwxi/Research/ATS-Xanadu/prelude/DATS/gbas.dats: 889(line=95, offs=1) -- 929(line=97, offs=26)
// { // val-binding
...
gl_print1_2233_ = g_print_2168_
;
xtmp195 = gl_print1_2233_(a3x4);
}
;
//L1PCKxpat(H0Pnil(); L1VALtmp(tmp(195)));
//L1CMDmatch(H0Pnil(); L1VALtmp(tmp(195)));
} // val(H0Pnil())
;
{
xtmp196 = [-1];;
...
;
xtmp185 = print_4_626_("prime(", xtmp187[1], ") = ", xtmp187[2]);
}
;
break;
default: XATS2JS_matcherr0();
...
;
return xtmp185;
} // function // StreamDemo2_xprint(11)
;
xtmp183 = StreamDemo2_xprint_776_(a1x1);
}
;
return xtmp183;
} // function // the_StreamDemo2_xprint(20)
