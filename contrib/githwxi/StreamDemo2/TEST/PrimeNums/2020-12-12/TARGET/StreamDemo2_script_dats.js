...
// ./PrimeNums.dats: 363(line=21, offs=1) -- 387(line=21, offs=25)
// L1DCLnone1(H0Cnone1(...))

// ./PrimeNums.dats: 408(line=23, offs=1) -- 465(line=25, offs=26)
// L1DCLnone0()

// ./PrimeNums.dats: 486(line=27, offs=1) -- 553(line=29, offs=30)
// L1DCLnone0()

// ./PrimeNums.dats: 554(line=30, offs=1) -- 651(line=32, offs=57)
// L1DCLnone0()

// ./PrimeNums.dats: 672(line=34, offs=1) -- 1032(line=61, offs=20)
// L1DCLnone0()

// ./PrimeNums.dats: 1089(line=63, offs=1) -- 1194(line=70, offs=8)
// L1DCLnone0()

// ./PrimeNums.dats: 1215(line=72, offs=1) -- 1256(line=73, offs=34)
// L1DCLnone0()

// ./PrimeNums.dats: 1277(line=75, offs=1) -- 1320(line=75, offs=44)
// { // include
...
let xtmp125;
let xtmp126;
// ./PrimeNums.dats: 733(line=38, offs=1) -- 808(line=44, offs=7)
function
fromto_736_(a2x1)
{
let xtmp95;
...
;
// ./PrimeNums.dats: 809(line=45, offs=1) -- 1008(line=60, offs=7)
function
helper_812_(a2x1)
{
let xtmp101;
...
let xtmp106;
let xtmp107;
// ./PrimeNums.dats: 867(line=51, offs=1) -- 898(line=52, offs=27)
{
xtmp102 = XATS2JS_lazy_eval(a2x1);
if(1!==xtmp102[0]) XATS2JS_patckerr0();
;
xtmp103 = xtmp102[1];
xtmp104 = xtmp102[2];
} // val(H0Pdapp(H0Pcon(strmcon_cons(0)); -1; H0Pvar(x0(5)), H0Pvar(xs(6))))
;
// ./PrimeNums.dats: 955(line=57, offs=1) -- 1000(line=57, offs=46)
// L1DCLnone0();
{
{
{
// /home/hwxi/Research/ATS-Xanadu/prelude/DATS/stream.dats: 4095(line=343, offs=1) -- 4426(line=371, offs=8)
function
stream_filter_3192_(a4x1)
{
let xtmp123;
;
// /home/hwxi/Research/ATS-Xanadu/prelude/DATS/stream.dats: 4164(line=351, offs=1) -- 4424(line=370, offs=8)
function
auxmain_4167_(a5x1)
{
let a5y1;
...
let xtmp111;
{
xtmp111 = auxloop_4212_(XATS2JS_lazy_eval(a5x1));
}
;
return xtmp111;
} // lam-function
;
xtmp110 = XATS2JS_new_lazy(xtmp112);
break;//return
} while( true );
return xtmp110;
} // function // auxmain(37)
...
;
xtmp121 = gint_mod_sint_sint_3788_(a6x1, xtmp103);
}
;
xtmp120 = gint_gt_sint_sint_2209_(xtmp121, 0);
}
;
return xtmp120;
} // function // filter$test(7)
;
xtmp118 = filter$test_2509_(xtmp116);
}
;
if
(xtmp118)
...
{
{
xtmp122 = auxmain_4167_(xtmp117);
}
;
xtmp114 = [1, xtmp116, xtmp122];
}
;
} // if-then
else
...
{
// tail-recursion:
// L1CMDapp(tmp(114); L1VALfcst(auxloop(38)); L1VALeval2(L1VALtmp(tmp(117))))
a5y1 = XATS2JS_lazy_eval(xtmp117); a5x1 = a5y1; continue;
}
;
} // if-else
;
...
;
{
xtmp123 = auxmain_4167_(a4x1);
}
;
return xtmp123;
} // function // stream_filter(10)
;
xtmp107 = stream_filter_3192_(xtmp104);
}
;
xtmp106 = helper_812_(xtmp107);
}
;
xtmp105 = [1, xtmp103, xtmp106];
}
;
return xtmp105;
} // lam-function
;
xtmp101 = XATS2JS_new_lazy(xtmp124);
return xtmp101;
} // function // helper(6)
;
{
{
xtmp126 = fromto_736_(2);
}
;
xtmp125 = helper_812_(xtmp126);
}
;
return xtmp125;
...
a0ref_get_2457_ = XATS2JS_a0ref_get
;
xtmp132 = a0ref_get_2457_(a4x1[2]);
}
;
;
} // val(H0Pvar(xs(67)))
...
{
xtmp133 = XATS2JS_lazy_eval(xtmp132);
if(0!==xtmp133[0]) XATS2JS_patckerr0();
;
xtmp134 = xtmp133[1];
xtmp135 = xtmp133[2];
...
;
xtmp136 = a0ref_set_2496_(a4x1[2], xtmp135);
}
;
...
;
return xtmp134;
} // function // StreamDemo_get_elt(42)
;
xtmp130 = StreamDemo_get_elt_202_(a3x1);
}
;
;
} // val(H0Pvar(opt(65)))
...
do {
do {
if(0!==xtmp130[0]) break;
xtmp138 = 1;
} while(false);
if(xtmp138 > 0 ) break;
do {
if(1!==xtmp130[0]) break;
xtmp138 = 2;
} while(false);
if(xtmp138 > 0 ) break;
} while(false);
...
a0ref_set_2496_ = XATS2JS_a0ref_set
;
xtmp142 = a0ref_set_2496_(a3x1[1], a3x2);
}
;
return xtmp142;
} // function // StreamDemo_set_dir(45)
;
{
...
;
xtmp143 = gint_sub_sint_sint_3524_(0, 1);
}
;
xtmp139 = StreamDemo_set_dir_343_(a2x1, xtmp143);
}
;
...
;
{
xtmp144 = loop_3096_(a2x1);
}
;
return xtmp144;
} // function // StreamDemo_reset(40)
;
xtmp127 = StreamDemo_reset_433_(xtop0);
}
;
return xtmp127;
...
a0ref_set_2496_ = XATS2JS_a0ref_set
;
xtmp150 = a0ref_set_2496_(a3x1[1], a3x2);
}
;
return xtmp150;
} // function // StreamDemo_set_dir(45)
...
gint_add_sint_sint_3439_ = XATS2JS_gint_add_sint_sint
;
xtmp151 = gint_add_sint_sint_3439_(0, 1);
}
;
xtmp147 = StreamDemo_set_dir_343_(a2x1, xtmp151);
}
;
...
a0ref_get_2457_ = XATS2JS_a0ref_get
;
xtmp154 = a0ref_get_2457_(a3x1[2]);
}
;
;
} // val(H0Pvar(xs(67)))
...
// ././../../../StreamDemo/DATS/StreamDemo.dats: 2620(line=219, offs=1) -- 2651(line=220, offs=27)
{
xtmp155 = XATS2JS_lazy_eval(xtmp154);
if(0!==xtmp155[0]) XATS2JS_patckerr0();
;
xtmp156 = xtmp155[1];
xtmp157 = xtmp155[2];
} // val(H0Pdapp(H0Pcon(strxcon_cons(4)); -1; H0Pvar(x0(68)), H0Pvar(xs(69))))
...
a0ref_set_2496_ = XATS2JS_a0ref_set
;
xtmp158 = a0ref_set_2496_(a3x1[2], xtmp157);
}
;
//L1PCKxpat(H0Pnil(); L1VALtmp(tmp(158)));
//L1CMDmatch(H0Pnil(); L1VALtmp(tmp(158)));
} // val(H0Pnil())
;
return xtmp156;
} // function // StreamDemo_get_elt(42)
;
xtmp152 = StreamDemo_get_elt_202_(a2x1);
}
;
return xtmp152;
} // function // StreamDemo_next1(48)
;
xtmp145 = StreamDemo_next1_492_(xtop0);
}
;
return xtmp145;
...
a0ref_set_2496_ = XATS2JS_a0ref_set
;
xtmp164 = a0ref_set_2496_(a3x1[1], a3x2);
}
;
return xtmp164;
} // function // StreamDemo_set_dir(45)
...
gint_sub_sint_sint_3524_ = XATS2JS_gint_sub_sint_sint
;
xtmp165 = gint_sub_sint_sint_3524_(0, 1);
}
;
xtmp161 = StreamDemo_set_dir_343_(a2x1, xtmp165);
}
;
...
a0ref_get_2457_ = XATS2JS_a0ref_get
;
xtmp168 = a0ref_get_2457_(a3x1[2]);
}
;
;
} // val(H0Pvar(xs(67)))
...
// ././../../../StreamDemo/DATS/StreamDemo.dats: 2620(line=219, offs=1) -- 2651(line=220, offs=27)
{
xtmp169 = XATS2JS_lazy_eval(xtmp168);
if(0!==xtmp169[0]) XATS2JS_patckerr0();
;
xtmp170 = xtmp169[1];
xtmp171 = xtmp169[2];
} // val(H0Pdapp(H0Pcon(strxcon_cons(4)); -1; H0Pvar(x0(68)), H0Pvar(xs(69))))
...
a0ref_set_2496_ = XATS2JS_a0ref_set
;
xtmp172 = a0ref_set_2496_(a3x1[2], xtmp171);
}
;
//L1PCKxpat(H0Pnil(); L1VALtmp(tmp(172)));
//L1CMDmatch(H0Pnil(); L1VALtmp(tmp(172)));
} // val(H0Pnil())
;
return xtmp170;
} // function // StreamDemo_get_elt(42)
;
xtmp166 = StreamDemo_get_elt_202_(a2x1);
}
;
return xtmp166;
} // function // StreamDemo_prev1(49)
;
xtmp159 = StreamDemo_prev1_554_(xtop0);
}
;
return xtmp159;
...
;
xtmp173 = StreamDemo2_title_170_();
}
;
return xtmp173;
...
;
xtmp174 = StreamDemo2_stream_name_307_();
}
;
return xtmp174;
...
;
xtmp175 = StreamDemo2_input_descript_462_();
}
;
return xtmp175;
...
;
return false;
} // function // StreamDemo2_pauseq(13)
;
xtmp177 = StreamDemo2_pauseq_710_(a1x1);
}
;
return xtmp177;
...
;
xtmp186 = gl_print1_2233_(a3x1);
}
;
//L1PCKxpat(H0Pnil(); L1VALtmp(tmp(186)));
//L1CMDmatch(H0Pnil(); L1VALtmp(tmp(186)));
} // val(H0Pnil())
;
{
xtmp187 = [-1];;
...
;
xtmp180 = StreamDemo2_xprint_849_(a1x1);
}
;
return xtmp180;
